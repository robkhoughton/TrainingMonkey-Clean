-- ACWR Migration System Database Schema
...
CREATE TABLE IF NOT EXISTS acwr_enhanced_calculations (
    ...
    CONSTRAINT fk_enhanced_calc_user FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
    CONSTRAINT fk_enhanced_calc_activity FOREIGN KEY (activity_id) REFERENCES activities(activity_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS acwr_migration_history (
    ...
    -- Foreign key constraints
    CONSTRAINT fk_migration_user FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS acwr_migration_batches (
    ...
    -- Foreign key constraints
    CONSTRAINT fk_batch_user FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
...
-- View for current migration progress
