@echo off
echo ========================================
echo Fixing Database Optimization Deployment
echo ========================================
echo.

echo [1/3] Building Docker image with corrected Dockerfile...
cd /d "%~dp0..\app"
...
echo.
echo The database optimization files are now included in the deployment.
