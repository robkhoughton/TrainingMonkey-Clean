    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <button onClick={navigateToPrevious} style={{
            padding: '8px 12px',
          ...
          <button onClick={navigateToToday} style={{
            padding: '8px 12px',
          ...
          <button onClick={navigateToNext} style={{
            padding: '8px 12px',
            backgroundColor: '#3b82f6',
            color: 'white',
            border: 'none',
          ...
          <table style={{
            ...
            <thead style={{
              ...
              <tr style={{ borderBottom: '2px solid #dee2e6' }}>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '120px' }}>Date</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '200px' }}>Today's Training Decision</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '180px' }}>Actual Activity</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '100px' }}>Energy (1-5)</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '100px' }}>RPE (1-10)</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '100px' }}>Pain %</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '200px' }}>Notes</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '80px' }}>Alignment</th>
                <th style={{ padding: '12px 8px', textAlign: 'center', minWidth: '100px' }}>Actions</th>
              </tr>
            </thead>
              ...
              {journalData.map((entry) => (
                <React.Fragment key={entry.date}>
                  ...
                  <tr style={{
                    ...
                    {/* Date Column with Autopsy Indicator */}
                      ...
                      {entry.ai_autopsy.autopsy_analysis && (
                        <button
                          ...
                          style={{
                            ...
                            padding: '2px 6px',
                            fontSize: '0.7rem',
                            backgroundColor: expandedAutopsies.has(entry.date) ? '#3b82f6' : '#e5e7eb',
                            color: expandedAutopsies.has(entry.date) ? 'white' : '#374151',
                            border: 'none',
                            borderRadius: '4px',
                            cursor: 'pointer',
                        ...
                        >
                          🔍 {expandedAutopsies.has(entry.date) ? 'Hide' : 'View'} Analysis
                        </button>
                      )}
                    </td>
                    ...
                    <td style={{ padding: '12px 8px', verticalAlign: 'top' }}>
                      <div style={{ fontSize: '0.875rem', lineHeight: '1.4', color: '#374151' }}>
                        {entry.activity_summary.type === 'rest' ? (
                    ...
                    {/* Actions */}
                    <td style={{ padding: '12px 8px', textAlign: 'center', verticalAlign: 'top' }}>
                      {savedEntries.has(entry.date) && !hasUnsavedChanges(entry) ? (
                        <button
                          disabled
                          style={{
                            padding: '6px 12px',
                        ...
                        <button
                          ...
                          style={{
                            padding: '6px 12px',
                            backgroundColor: isSaving === entry.date ? '#6b7280' : '#3b82f6',
                            color: 'white',
                            border: 'none',
                            borderRadius: '4px',
                            fontSize: '0.875rem',
                        ...
                        >
                          {isSaving === entry.date ? 'Saving...' : 'Save'}
                        </button>
                      )}
                    </td>
                  </tr>
