...
const TrainingLoadDashboard: React.FC<TrainingLoadDashboardProps> = ({ onNavigateToTab }) => {
  ...
  // Post-sync: routing is now handled by App.tsx smart routing via /api/app-state.
  // On sync complete, reload so the app re-evaluates routing on next load.
  const handleSyncComplete = () => {
    sessionStorage.removeItem('ytm_app_state_checked');
