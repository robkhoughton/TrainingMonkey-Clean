...
This unblocks the Specification Clarity score (03) and the season-goal floor of the Adequate Context Gate (04, merged from the original ticket 05) — both need a non-race goal to count as a fully legitimate, fully "clear" season goal, not a degraded or penalized case.
...
is the new unifying presence check for ticket 03 and the season-goal floor of ticket 04 (merged from the original ticket 05). See commit 3bc54d8.
