...
QUERY_AUDIT_CHECKLIST = [
    "✓ journal_entries queries - FIXED",
    "✓ ai_autopsies queries - FIXED", 
    "⏳ activities queries - NEEDS REVIEW",
    "⏳ llm_recommendations queries - NEEDS REVIEW",
    "⏳ user_settings queries - NEEDS REVIEW",
    "⏳ Any JOIN queries with date conditions",
]

# 2. Audit all date-based lookup dictionaries
LOOKUP_AUDIT_CHECKLIST = [
    "✓ obs_by_date - FIXED",
    "✓ autopsy_by_date - FIXED",
    "⏳ recommendations_by_date - NEEDS REVIEW", 
    "⏳ activities_by_date - NEEDS REVIEW",
    "⏳ Any other date-keyed dictionaries",
]
...
API_AUDIT_CHECKLIST = [
    ...
    "⏳ Any date fields in JSON responses",
]
...
FRONTEND_AUDIT_CHECKLIST = [
    "⏳ Chart date parsing in React components",
    "⏳ Date filtering in dashboard charts", 
    "⏳ Timezone handling in journal page",
...
def test_date_consistency():
    ...
    test_cases = [
        "✓ Journal observations display",
        "✓ Autopsy alignment scores display",
        "⏳ Dashboard chart data alignment", 
        "⏳ ACWR calculations accuracy",
        "⏳ Activity summaries correctness",
        "⏳ Recommendation date targeting",
    ]
